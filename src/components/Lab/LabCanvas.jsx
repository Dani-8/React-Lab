                            ...
                            <div key={idx} className="space-y-2">
                                <div className="flex justify-between text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                                    ...
                                    <span className='info-icon hover:text-orange-500 cursor-pointer flex items-center gap-1 relative group text-slate-400 transition-all duration-400'>
                                        ...
                                        <span className='absolute top-7 -left-45 p-2 border-l-3 border border-orange-400 bg-slate-100 text-slate-600 font-bolder text-[8px] rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-400 pointer-events-none shadow-xl'>
